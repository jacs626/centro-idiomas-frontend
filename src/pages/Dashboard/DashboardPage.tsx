  ...
  return (
    <Navbar>
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-slate-500 mt-1 text-sm sm:text-base">Bienvenido, Profesor</p>
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
        {quickActionsProfesor.map((item) => (
...
export default function DashboardPage() {
  const { isAlumno, isProfesor } = useAuth();
